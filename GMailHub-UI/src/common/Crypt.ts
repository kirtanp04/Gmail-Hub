...
export class Crypt {
    ...
    private static key = CryptoTS.enc.Utf8.parse(import.meta.env.VITE_CRYPTO_ENCRYPTION_KEY);

    private static Iv = CryptoTS.enc.Utf8.parse(import.meta.env.VITE_CRYPTO_IV);
